<div id="{$id}">
    <form data-si-preset="dataedit" data-si-form="userData" enctype="multipart/form-data">
            ...
            <div class="profile-item">
                <div class="container-small">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="input" name="extended[surname]" value="##$extended[surname]?:$names[0]}" ##($_modx->user.status in list [1,2]) ? 'disabled' : ''}>
                        <small class="error" data-si-error="extended[surname]"></small>
                    </div>

                    <div class="input-group">
                        <label class="input-label">Имя*</label>
                        <input type="text" class="input" name="extended[name]" value="##$extended[name]?:$names[1]}" ##($_modx->user.status in list [1,2]) ? 'disabled' : ''}>
                        <small class="error" data-si-error="extended[name]"></small>
                    </div>

                    <div class="input-group">
                        <label class="input-label">Отчество*</label>
                        <input type="text" class="input" name="extended[fathername]" value="##$extended[fathername]?:$names[2]}" ##($_modx->user.status in list [1,2]) ? 'disabled' : ''}>
                    ...
                    <div class="input-group">
                        ...
                        <div class="columns">
                            <div class="column col-4 md-col-12">
                                <input type="text" class="input" placeholder="Индекс" name="zip" value="##$_modx->user.zip}" data-match-recepient="zip_fact" ##($_modx->user.status in list [1,2]) ? 'disabled' : ''}>
                                <small class="error" data-si-error="zip"></small>
                            </div>
                            <div class="column col-8 md-col-12">
                                <input type="text" class="input" placeholder="Адрес" name="address" value="##$_modx->user.address}" data-match-recepient="address_fact" ##($_modx->user.status in list [1,2]) ? 'disabled' : ''}>
                    ...
                    <div class="input-group">
                        ...
                        <div class="columns">
                            <div class="column col-4 md-col-12">
                                <input type="text" class="input" placeholder="Индекс" name="zip_fact" value="##$_modx->user.zip_fact}" ##($_modx->user.status in list [1,2]) ? 'disabled' : ''}>
                                <small class="error" data-si-error="zip_fact"></small>
                            </div>
                            <div class="column col-8 md-col-12">
                                <input type="text" class="input" placeholder="Адрес" name="address_fact" value="##$_modx->user.address_fact}" ##($_modx->user.status in list [1,2]) ? 'disabled' : ''}>
                        ...
                        <label class="checkbox-label" style="margin-top:30px;">
                            ...
                            ##set $checked = 'checked'}
                            ##/if}
                            <input type="checkbox" class="checkbox" data-match-donor="address,zip" ##$checked} ##($_modx->user.status in list [1,2]) ? 'disabled' : ''}>
                    ...
                    <div class="columns">
                        <div class="column col-6 md-col-12">
                            <label class="checkbox-label">
                                <input type="radio" class="checkbox" name="legal_form" value="Самозанятый" ##$_modx->user.legal_form == 'Самозанятый' ? 'checked' : ''} ##($_modx->user.status in list [1,2]) ? 'disabled' : ''}>
                                <span class="checkbox-text radio-text">Самозанятый</span>
                            </label>
                        </div>
                        <div class="column col-6 md-col-12">
                            <label class="checkbox-label">
                                <input type="radio" class="checkbox" name="legal_form" value="ИП" ##$_modx->user.legal_form == 'Самозанятый' ? '' : 'checked'} ##($_modx->user.status in list [1,2]) ? 'disabled' : ''}>
                        ...
                        <div class="column col-6 md-col-12">
                            ...
                            <div class="container-small">
                                ...
                                <div class="input-group ##$_modx->user.legal_form == 'Самозанятый' ? '' : 'd-none'}" data-legal-form="Самозанятый">
                                    ...
                                    <input type="text" class="input" name="extended[certificate_num]" value="##$extended[certificate_num]}" ##($_modx->user.status in list [1,2]) ? 'disabled' : ''}>
                                ...
                                <div class="input-group ##$_modx->user.legal_form == 'Самозанятый' ? '' : 'd-none'}" data-legal-form="Самозанятый">
                                    ...
                                    <input type="text" class="input" name="extended[certificate_date]" value="##$extended[certificate_date]}" ##($_modx->user.status in list [1,2]) ? 'disabled' : ''}>
                                ...
                                <div class="input-group ##$_modx->user.legal_form == 'Самозанятый' ? 'd-none' : ''}" data-legal-form="ИП">
                                    ...
                                    <label class="checkbox-label" style="margin-top:30px;">
                                        ...
                                        ##set $checked = 'checked'}
                                        ##/if}
                                        <input type="checkbox" class="checkbox" data-match-donor="extended[pass_address]" ##$checked} ##($_modx->user.status in list [1,2]) ? 'disabled' : ''}>
                                ...
                                <div class="input-group ##$_modx->user.legal_form == 'Самозанятый' ? 'd-none' : ''}" data-legal-form="ИП">
                                    ...
                                    <input type="text" class="input" name="extended[ogrnip]" value="##$extended[ogrnip]}" ##($_modx->user.status in list [1,2]) ? 'disabled' : ''}>
                    ...
                    <div class="column col-6 md-col-12">
                        ...
                        <div class="container-small">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="input" name="extended[rs]" value="##$extended[rs]}" ##($_modx->user.status in list [1,2]) ? 'disabled' : ''}>
                                <small class="error" data-si-error="extended[rs]"></small>
                            </div>

                            <div class="input-group">
                                <label class="input-label">БИК*</label>
                                <input type="text" class="input" name="extended[bik]" value="##$extended[bik]}" ##($_modx->user.status in list [1,2]) ? 'disabled' : ''}>
                                <small class="error" data-si-error="extended[bik]"></small>
                            </div>

                            <textarea class="input textarea" name="extended[card_data]" ##($_modx->user.status in list [1,2]) ? 'disabled' : ''} placeholder="Получатель, Банк получателя, Корр. счёт, ИНН, КПП, SWIFT-код">##$extended[card_data]}</textarea>
                ...
                <div class="container-small">
                    ...
                    <div class="input-group ##$_modx->user.legal_form == 'Самозанятый' ? '' : 'd-none'}" data-legal-form="Самозанятый" data-si-preset="selfemployed_img" data-si-form="certUploadForm">
                        <div data-fu-wrap>
                            ...
                            <div class="file">
                                <input type="file" data-fu-field name="selfemployed_img" ##($_modx->user.status in list [1,2]) ? 'disabled' : ''} class="file-form__file">
                    ...
                    <div class="input-group ##$_modx->user.legal_form == 'Самозанятый' ? '' : 'd-none'}" data-legal-form="Самозанятый" data-si-preset="pass_one_img" data-si-form="passOneUploadForm">
                        <div data-fu-wrap>
                            ...
                            <div data-fu-progress=""></div>
                            <div class="file">
                                <input type="file" data-fu-field name="pass_one_img" ##($_modx->user.status in list [1,2]) ? 'disabled' : ''} class="file-form__file">
                                <div class="file-text">загрузите фотографию</div>
                            </div>
                            <template data-fu-tpl>
                                <button type="button" class="btn file-list__btn" data-fu-path="$path">$filename x</button>
                    ...
                    <div class="input-group ##$_modx->user.legal_form == 'Самозанятый' ? '' : 'd-none'}" data-legal-form="Самозанятый" data-si-preset="pass_two_img" data-si-form="passTwoUploadForm">
                        <div data-fu-wrap>
                            ...
                            <div data-fu-progress=""></div>
                            <div class="file">
                                <input type="file" data-fu-field name="pass_two_img" ##($_modx->user.status in list [1,2]) ? 'disabled' : ''} class="file-form__file">
                                <div class="file-text">загрузите фотографию</div>
                            </div>
                            <template data-fu-tpl>
                                <button type="button" class="btn file-list__btn" data-fu-path="$path">$filename x</button>
                    ...
                    <div class="input-group ##$_modx->user.legal_form == 'Самозанятый' ? '' : 'd-none'}" data-legal-form="Самозанятый" data-si-preset="insurance_img" data-si-form="insuranceUploadForm">
                        <div data-fu-wrap>
                            ...
                            <div data-fu-progress=""></div>
                            <div class="file">
                                <input type="file" data-fu-field name="insurance_img" ##($_modx->user.status in list [1,2]) ? 'disabled' : ''} class="file-form__file">
                                <div class="file-text">загрузите фотографию</div>
                            </div>
                            <template data-fu-tpl>
                                <button type="button" class="btn file-list__btn" data-fu-path="$path">$filename x</button>
                    ...
                    <div class="input-group ##$_modx->user.legal_form == 'Самозанятый' ? 'd-none' : ''}" data-legal-form="ИП" data-si-preset="certificate_img" data-si-form="certificateUploadForm">
                        <div data-fu-wrap>
                            ...
                            <div data-fu-progress=""></div>
                            <div class="file">
                                <input type="file" data-fu-field name="certificate_img" ##($_modx->user.status in list [1,2]) ? 'disabled' : ''} class="file-form__file">
                                <div class="file-text">загрузите фотографию</div>
                            </div>
                            <template data-fu-tpl>
                                <button type="button" class="btn file-list__btn" data-fu-path="$path">$filename x</button>
                    ...
                    ##else}
                    <input type="hidden" name="extended[certificate_img]" ##($_modx->user.status in list [1,2]) ? 'disabled' : ''} value="##$extended.certificate_img}">
                    ...
                    <div class="input-group ##$_modx->user.legal_form == 'Самозанятый' ? 'd-none' : ''}" data-legal-form="ИП" data-si-preset="inn_img" data-si-form="innUploadForm">
                        <div data-fu-wrap>
                            ...
                            <div data-fu-progress=""></div>
                            <div class="file">
                                <input type="file" data-fu-field name="inn_img" ##($_modx->user.status in list [1,2]) ? 'disabled' : ''} class="file-form__file">
                                <div class="file-text">загрузите фотографию</div>
                            </div>
                            <template data-fu-tpl>
                                <button type="button" class="btn file-list__btn" data-fu-path="$path">$filename x</button>
                    ...
                    ##else}
                    <input type="hidden" name="extended[inn_img]" ##($_modx->user.status in list [1,2]) ? 'disabled' : ''} value="##$extended.inn_img}">
        ...
        <div class="btn-footer">
            <button type="submit" class="btn btn--small" ##($_modx->user.status in list [1,2]) ? 'disabled' : ''}>На модерацию</button>
        </div>
    </form>
