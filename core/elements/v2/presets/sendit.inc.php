...
return [
    ...
    'dataedit' => [
        ...
        extended[insurance]:requiredIf=^legal_form|Самозанятый^:checkNumberLength=^11^,
        ...
        inn_ip:requiredIf=^legal_form|ИП^:checkNumberLength=^12^,
        inn_self:requiredIf=^legal_form|Самозанятый^:checkNumberLength=^12^,
