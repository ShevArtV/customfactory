...
<div id="{$id}" data-mpc-section="user_progress" data-mpc-name="Прогресс пользователя">
    ...
    <div class="page-layout offset-top offset-top--small">
        ...
        <div class="page-layout__aside" data-mpc-snippet="pdoResources|help_aside">
            <a href="{$uri}" class="block-link" data-mpc-chunk="pdoresources/help_aside/item.tpl">
        ...
        <div class="tg-showcase__warp">
            <div class="tg-showcase__content">
                ...
                <div class="tg-showcase__footer">
                    <a href="#" class="btn btn--full" data-mpc-field="target">
        ...
        <div class="page-layout__content container-medium">
            ...
            <div data-tab-wrapper data-mpc-snippet="getFAQ|default">
                <div data-mpc-unwrap="1" data-mpc-chunk="getfaq/default/wrap.tpl">
                    <div class="round-tabs">
                        {$nav}
                        <button data-tab-target="{$type}" data-mpc-remove="1" type="button" class="round-tabs__item {$active ? 'active' : ''}" data-mpc-chunk="getfaq/default/nav_item.tpl">{$typeName}</button>
                    </div>
            ...
            <div data-mpc-field="list_faq" data-mpc-remove="1">
                ...
                <div data-mpc-item="">
                    ...
                    <div data-mpc-field-1="answer">
                        <p>Самозанятыми называют плательщиков налога на профессиональный доход (НПД). Самозанятые работают на себя, платят низкий налог НПД 4-6%, не нанимают работников, не платят страховые взносы и не сдают отчёты. </p>
                ...
                <div data-mpc-item="">
                    ...
                    <div data-mpc-field-1="answer">
                        Вы можете совмещать основную работу с дополнительной профессиональной деятельностью. При этом работодатель будет оплачивать за вас НДФЛ 13% с дохода от работы по трудовому договору, а вы сами будете дополнительно оплачивать налог на профессиональный доход.
                    </div>
                    <div data-mpc-field-1="type">self-employment</div>
                </div>
                <div data-mpc-item="">
                    ...
                    <div data-mpc-field-1="answer">
                        Нет, самозанятый сам декларирует сумму дохода ежемесячно. После поступления средств на счет вы самостоятельно создаёте электронный чек, подтверждающий полученный доход. ФНС учтёт сумму чека при расчёте налога. Если поступившие на счет деньги не относятся к вашему профессиональному доходу – например, если это перевод от друга, родственника и т.п., вы не формируете чек и эти деньги не учитываются при подсчете налога.
                    </div>
                    <div data-mpc-field-1="type">income</div>
                </div>
                <div data-mpc-item="">
                    <div data-mpc-field-1="question">Если я решу перестать быть самозанятым, это легко сделать?</div>
                    <div data-mpc-field-1="answer">Перестать быть самозанятым так же просто, как зарегистрироваться в качестве самозанятого. Если вы регистрировались через приложение банка, нужно будет просто отключить сервис.</div>
                    <div data-mpc-field-1="type">self-employment</div>
                </div>
                <div data-mpc-item="">
                    <div data-mpc-field-1="question">Есть ли ограничение по месячному доходу самозанятого?</div>
                    <div data-mpc-field-1="answer"><p>Для самозанятых есть ограничение по объему годового дохода — он не должен превысить 2,4 миллиона рублей. Ограничения по объёму дохода за месяц нет: в один месяц вы можете получить 500 000 рублей, в другой — 50 000, в третий — 0. Важно не превысить годовое ограничение.</p>
                        <p>Если вы превысите годовой лимит, придётся перейти на другой налоговый режим – например, оформить статус индивидуального предпринимателя (ИП).</p></div>
                    <div data-mpc-field-1="type">income</div>
                </div>
                <div data-mpc-item="">
                    ...
                    <div data-mpc-field-1="answer"><p>Самозанятый должен делать всего две вещи:</p>
                        <ol>
                            <li>1. При каждом получении денег от нашего сервиса — сформировать и передать нам чек. Как в магазине при покупке любого товара вам обязаны выдать кассовый чек, так и вы после оплаты должны отправить чек. Формирование чеков — ваша личная ответственность как плательщика налога на профессиональный доход.</li>
                ...
                <div data-mpc-item="">
                    ...
                    <div data-mpc-field-1="answer">
                        ...
                        <p>Когда вы получили выплаты с нашего сервиса, вы заявляете о поступлении как о доходе в своем приложении. Тут же, в приложении, формируется ссылка на чек — его надо передать нам.</p>
                ...
                <div data-mpc-item="">
                    ...
                    <div data-mpc-field-1="answer">
                        У самозанятого нет фиксированных платежей — большое преимущество этого налогового режима. Нет поступлений — нет налога. Если вы решили отдохнуть, налоги и сборы за дни «простоя» платить не надо.
                    </div>
                    <div data-mpc-field-1="type">income</div>
                </div>
                <div data-mpc-item="">
                    ...
                    <div data-mpc-field-1="answer">
                        Каждому самозанятому при постановке на учет полагается сумма для уменьшения налога — 10 тысяч рублей. Ее нельзя обналичить, можно только уменьшать за счет этой суммы налог – до тех пор, пока эти деньги не закончатся. Работает это так. Первое время вы будете платить не 4, а 3% налога от дохода. И так можно будет делать, пока эти 10 тысяч рублей не израсходуются. Налоговый вычет дают только один раз в жизни самозанятого – в качестве бонуса за использование этого налогового режима.
                    </div>
                    <div data-mpc-field-1="type">income</div>
                </div>
                <div data-mpc-item="">
                    ...
                    <div data-mpc-field-1="answer">
                        <p>Для подтверждения дохода вы можете запросить справку через приложение «Мой налог» или в личном кабинете на сайте ФНС. Другой вариант — предоставить справку по форме банка. Туда можно вписать любые доходы, в том числе неофициальные: проверять их не будут.</p>
                        <p>Пока статус самозанятого никак не влияет на решение банка выдать кредит: банки достаточно консервативны и предпочитают иметь дело с кредиторами, которые могут подтвердить свой доход и постоянную занятость через работодателя. Однако количество самозанятых постоянно растет, поэтому многие крупные банки заявляют, что готовят спецпредложения по кредитам для самозанятых.</p>
                    </div>
                    <div data-mpc-field-1="type">income</div>
                </div>
            </div>
