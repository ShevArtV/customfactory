...
<div id="{$id}" data-mpc-section="moderate_users" data-mpc-name="Модерация дизайнеров">
        <div data-mpc-unwrap="1" data-mpc-snippet="!ffGetFilterForm|designers">
            <form data-mpc-chunk="fffiltering/designers/ffform.tpl" class="filter" id="filterForm" data-ff-form="" data-si-preset="{$presetName}">
                <input type="hidden" name="configId" value="{$configId}">
                <input type="hidden" name="configId" form="generateReport" value="{$configId}">
                <div class="filter-column">
                    <div class="filter-item">
                        <div class="filter-name">Дизайнеров: <span data-ff-total="total">{$totalResources?:0}</span></div>
                    </div>
                    {$filters}
        ...
        <div class="designer-items" data-pn-result="filters" data-mpc-snippet="!Pagination|designers">
